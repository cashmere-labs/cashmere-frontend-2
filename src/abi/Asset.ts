...
export type AssetEvents = 'Approval' | 'RoleAdminChanged' | 'RoleGranted' | 'RoleRevoked' | 'Transfer';
...
export interface Asset {
   ...
   * Type: constructor
   * @param mappingToken Type: address, Indexed: false
   * @param assetName Type: string, Indexed: false
   * @param assetSymbol Type: string, Indexed: false
   */
  'new'(
    mappingToken: string,
    assetName: string,
   ...
   * @param amount Type: uint256, Indexed: false
   */
  burn(from: string, amount: BigNumberish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
   ...
   * @param amount Type: uint256, Indexed: false
   */
  release(to: string, amount: BigNumberish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
  /**
   * Payable: false
   * Constant: false
   * StateMutability: nonpayable
